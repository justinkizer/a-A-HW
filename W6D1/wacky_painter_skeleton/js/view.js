...
View.prototype.exercise4 = function () {
  ...
  $('.square:nth-child(even)').text("Justin");
};
...
View.prototype.exercise5 = function () {
  ...
  $('.square').on("click", (square) => { alert(`You've clicked on Square: ${$(square.currentTarget).attr("data-pos")}!`);});
};
...
View.prototype.exercise7 = function(){
  ...
  $('#easel').on("mouseenter", ".square", (square) => {
    console.log($(square.currentTarget).css("background-color"));
  });
};
